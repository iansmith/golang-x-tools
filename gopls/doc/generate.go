...
import (
	...
	"github.com/iansmith/golang-x-tools/internal/lsp/command/commandmeta"
...
func rewriteAPI(_ []byte, api *source.APIJSON) ([]byte, error) {
	...
	fmt.Fprintf(&buf, "// Code generated by \"github.com/iansmith/golang-x-tools/gopls/doc/generate\"; DO NOT EDIT.\n\npackage source\n\nvar GeneratedAPIJSON = ")
	if err := printsrc.NewPrinter("github.com/iansmith/golang-x-tools/internal/lsp/source").Fprint(&buf, api); err != nil {
		return nil, err
	}
