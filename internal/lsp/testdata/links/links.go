...
import (
	...
	"github.com/iansmith/golang-x-tools/internal/lsp/foo" //@link(`github.com/iansmith/golang-x-tools/internal/lsp/foo`,`https://pkg.go.dev/github.com/iansmith/golang-x-tools/internal/lsp/foo?utm_source=gopls`)
