...
which can be slide presentations as in github.com/iansmith/golang-x-tools/cmd/present
...
*/
package present // import "github.com/iansmith/golang-x-tools/present"
