...
package main // import "github.com/iansmith/golang-x-tools/cmd/callgraph"
...
import (
	...
	"github.com/iansmith/golang-x-tools/go/callgraph/cha"
	"github.com/iansmith/golang-x-tools/go/callgraph/rta"
	"github.com/iansmith/golang-x-tools/go/callgraph/static"
	"github.com/iansmith/golang-x-tools/go/callgraph/vta"
	"github.com/iansmith/golang-x-tools/go/packages"
	"github.com/iansmith/golang-x-tools/go/pointer"
...
-format    Specifies the format in which each call graph edge is displayed.
           One of:
            ...
            digraph     output suitable for input to
                        github.com/iansmith/golang-x-tools/cmd/digraph.
...
Examples:
  ...
  Show all functions directly called by the callgraph tool's main function:
    ...
    callgraph -format=digraph github.com/iansmith/golang-x-tools/cmd/callgraph |
      digraph succs github.com/iansmith/golang-x-tools/cmd/callgraph.main
`
